...
on the right hand side are zero, but for $l=0, 1, 2$ they give us more
conditions to satisfy, but let's not worry about it for now and just set them
to zero. Then our weak formulation looks like:
$$\int_0^a {1\over2}R'(x)v'(x)+{1\over r}R(x)v'(x)+
